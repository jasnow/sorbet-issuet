...
module ActionController::Flash
  ...
  def redirect_to(options = _, response_status_and_flash = _); end
end
...
module ActionController::HttpAuthentication::Basic::ControllerMethods::ClassMethods
  def http_basic_authenticate_with(options = _); end
end
...
module ActionController::Redirecting
  ...
  def redirect_to(options = _, response_status = _); end
...
class ActionDispatch::ContentSecurityPolicy
  ...
  def build(context = _, nonce = _); end
...
class ActionDispatch::DebugExceptions
  def initialize(app, routes_app = _, response_format = _); end
...
class ActionDispatch::Http::ParameterFilter::CompiledFilter
  ...
  def blocks; end
  def call(original_params, parents = _); end
...
class ActionDispatch::Journey::Route
  def initialize(name, app, path, constraints, required_defaults, defaults, request_method_match, precedence, internal = _); end
