...
module ActiveJob::Exceptions::ClassMethods
  ...
  def retry_on(exception, wait: _, attempts: _, queue: _, priority: _); end
end
...
module ActiveJob::TestHelper
  ...
  def assert_no_enqueued_jobs(only: _, except: _, &block); end
  def assert_no_performed_jobs(only: _, except: _, &block); end
  def assert_performed_jobs(number, only: _, except: _); end
  def assert_performed_with(job: _, args: _, at: _, queue: _); end
  def before_setup; end
  def enqueued_jobs(*args, &block); end
  def enqueued_jobs=(arg); end
  def perform_enqueued_jobs(only: _, except: _); end
  ...
  def enqueued_jobs_size(only: _, except: _, queue: _); end
