...
class ActiveRecord::Associations::Builder::Association
  ...
  def self.create_reflection(model, name, scope, options, extension = _); end
...
class ActiveRecord::StatementCache
  ...
  def self.create(connection, block = _); end
...
class ActiveRecord::FixtureSet
  ...
  def self.create_fixtures(fixtures_directory, fixture_set_names, class_names = _, config = _); end
